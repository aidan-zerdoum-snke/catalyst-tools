...
# Synthetic
IMAGE_DIR = Path(r"C:\Python\catalyst-tools\catalyst_raw\Dataset313_ModelB\testing\images")   # contains *_0000.nii.gz
LABEL_DIR = Path(r"C:\Python\catalyst-tools\catalyst_raw\Dataset313_ModelB\testing\predictions")   # contains *.nii.gz (no _0000)

IJV_LABEL_ID = 3
CCA_LABEL_ID = 2

#OUTPUT_CSV = Path(r"C:\Users\shane.sicienski\OneDrive - Brainlab SE\Desktop\summary_SegThyUS.csv")
OUTPUT_CSV = Path(r"C:\Python\catalyst-tools\catalyst_raw\Dataset313_ModelB\testing\validation_output\summary_ModelB.csv")
